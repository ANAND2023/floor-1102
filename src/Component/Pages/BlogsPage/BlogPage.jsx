...
//   return (
//     <>
//       <section className='blog w-[90%]  mx-auto'>
//         <div className='container grid-cols-3 gap-5  '>

//           {blog.map((item) => (
//              <Link to={`/blogs/${item.id}`} className='link'>

//       {/* <Card  title={item.title} imageUrl={item.cover}  content={item.desc} link={item.id} /> */}
//             <div className='box boxItems p-5 border' key={item.id}>
//               <div className='img'>
