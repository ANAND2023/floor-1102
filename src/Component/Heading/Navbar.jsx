...
const Navbar = () => {
    ...
    return (
        <header className={`fixed w-full z-20 ${prevScrollPos? "":"top-6 "} left-0 border-gray-200 dark:border-gray-600 transition-transform duration-300 ${visible ? 'translate-y-0' : '-translate-y-full'}`}>
            <nav className="max-w-[90vw] bg-white px-2 rounded-sm flex flex-wrap justify-between items-center relative mx-auto py-2">
